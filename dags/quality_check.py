    ...
    check_fact_product_view = DataQualityOperator(
        ...
        checks=[
            ...
            },
            {
                ...
                'sql': 'SELECT COUNT(*) FROM fact_product_view WHERE view_id IS NULL',
                'expected': 0,
                'operator': 'eq',
            },
            {
                'name': 'no_null_event_ts',
                'sql': 'SELECT COUNT(*) FROM fact_product_view WHERE event_ts IS NULL',
                'expected': 0,
                'operator': 'eq',
            },
            {
            ...
            },
            {
                ...
                'sql': 'SELECT COUNT(*) - COUNT(DISTINCT view_id) FROM fact_product_view',
                'expected': 0,
                'operator': 'eq',
            },
            {
            ...
            },
            {
                ...
                'sql': 'SELECT COUNT(*) FROM fact_product_view WHERE store_key IS NULL',
                'expected': 0,
                'operator': 'eq',
            },
            {
                'name': 'no_null_device_key',
                'sql': 'SELECT COUNT(*) FROM fact_product_view WHERE device_key IS NULL',
                'expected': 0,
                'operator': 'eq',
            },
            {
                'name': 'no_null_date_key',
                'sql': 'SELECT COUNT(*) FROM fact_product_view WHERE date_key IS NULL',
                'expected': 0,
                'operator': 'eq',
            },
            {
                'name': 'no_null_ip_address',
                'sql': 'SELECT COUNT(*) FROM fact_product_view WHERE ip_address IS NULL',
                'expected': 0,
                'operator': 'eq',
            },
            {
